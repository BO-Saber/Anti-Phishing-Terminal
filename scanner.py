...
API_KEY = "YAIzaSyB7op-OCtkXRd-3_EuY71B5RtQHuqvag9s"
...
def check_google_safe_browsing(url):
    ...
    """
    if not API_KEY or API_KEY == "YAIzaSyB7op-OCtkXRd-3_EuY71B5RtQHuqvag9s":
        return "Google Safe Browsing not enabled (API key missing)"
    
    api_url = f"https://safebrowsing.googleapis.com/v4/threatMatches:find?key=YAIzaSyB7op-OCtkXRd-3_EuY71B5RtQHuqvag9s"
    payload = {
        "client": {
